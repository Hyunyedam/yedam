...
# 문제 53 리스트명.insert( 인덱스번호, 추가할 변수 ) : 인덱스 위치에 추가
movie_rank = ["닥터 스트레인지", "스플릿", "럭키"]
movie_rank.insert(1, "슈퍼맨") # 1번 인덱스에 슈퍼맨 추가

# 문제 54 : del 리스트명 [ 인덱스번호 ] : 해당 인덱스번호가 삭제
movie_rank = [ '닥터 스트레인지','슈퍼맨','스플릿','배트맨']
del movie_rank[3] # 럭키 삭제

# 문제 55 : del 리스트명 [ 인덱스번호 ] : 해당 인덱스번호가 삭제
movie_rank = ["닥터 스트레인지", "슈퍼맨", "스플릿", '배트맨']
del movie_rank[2] # 스플릿 삭제 => 배드맨 => 스플릿 자리로 이동
